        ...
        <div className="min-h-screen bg-gradient-to-r from-yellow-500 via-yellow-800 to-orange-500 flex justify-center items-center">
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <label htmlFor="email" className="block text-gray-700" required>Email</label>
                        <input
                            type="email"
                            id="email"
                            name="email"
                    ...
                    <div>
                        <label htmlFor="password" className="block text-gray-700" required>Mot de passe</label>
                        <input
                            type="password"
                            id="password"
                            name="password"
